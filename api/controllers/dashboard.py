...
class DashboardView(View):
    def get(self, request, **kwargs):
        ...
        if request.session.get('person_logged_id'):
            return JsonResponse({
                'status': 200,
                'personList': self._fetch_dashboard_person_data(person_type_id_logged, person_cost_center_id_logged),
    ...
    def _fetch_dashboard_person_data(self, person_type, cost_center):
        person_list = []
